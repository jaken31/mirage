...
also fails when more than 10% of generated frames are frozen (decided
2026-09-25; the bar is `validator.rollout_frozen_share_max`), which that run's
rollouts now fail, and the gate prints the frozen share on row 6 and under the
table. The
